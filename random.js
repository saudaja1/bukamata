function rpthumbnt(json) {
 ...
 for (var i = 0; i < numposts; i++) {
  ...
  try {
   ...
   if ((a != -1) && (b != -1) && (c != -1) && (d != "")) {
    thumburl = d
   } else thumburl = 'https://4.bp.blogspot.com/-OfH4XCedFks/WLBU-utsqiI/AAAAAAAABs4/5Z-MnifyV20f2Y2dRC2pW02B3Ab-SBJggCLcB/s1600/noimagethumb.gif'
  }
  document.write('<li class="news-title clearfix">');
  document.write('<a href="http://www.bukamata.id" target="_blank"><img src="' + thumburl + '"/></a>');
